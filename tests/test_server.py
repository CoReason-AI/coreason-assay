...
def test_upload_corpus(mock_upload_bec, mocker):
    # Setup mock return
    corpus = TestCorpus(
        project_id="p1",
        name="Test Corpus",
...
def test_upload_corpus_unlink_failure(mock_upload_bec, mocker):
...
def test_upload_corpus_failure(mock_upload_bec, mocker):
...
def test_run_assay_missing_dependencies():
...
def test_run_assay_missing_llm_client(mock_dependencies):
...
def test_run_assay_all_graders(mock_dependencies, mocker):
